...
const Chat = () => {
  ...
  useEffect(() => {
    ...
    const handleMessage = (msg) => {
      ...
      const openedGroupId = selectedGroup?._id?.toString();

      /* ===== GROUP MESSAGE FIX ===== */
      if (groupId && groupId === openedGroupId) {
  ...
  const openGroup = async (group) => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.REACT_APP_API_URL}/chat/group/messages/${group._id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`
          }
            ...
            <div className="col-md-4 chat-sidebar border-end">
              ...
              <div className="user-scroller">
                ...
                {filteredUsers.map((u) => (
                  ...
                  <div
                    key={u._id}
                    className={`user-pill ${selectedUser?._id === u._id ? "pill-active" : ""
                      }`}
                    onClick={() => openChat(u)}
                  >
                ...
                {groups.map((g) => (
                  ...
                  <div
                    key={g._id}
                    className={`user-pill ${selectedGroup?._id === g._id ? "pill-active" : ""
                      }`}
                    onClick={() => openGroup(g)}
                  >
                  ...
                  <div className="messages-flow">
                    ...
                    {messages.map((m) => {
                      ...
                      return (
                        ...
                        <div
                          key={m._id}
                          className={`msg-wrapper ${isMe ? "msg-me" : "msg-them"
                            }`}
                        >
